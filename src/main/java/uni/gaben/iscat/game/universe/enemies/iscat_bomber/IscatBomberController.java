...
public class IscatBomberController extends AiBehaviours<IscatBomberModel> {
    ...
    public IscatBomberController(IscatBomberModel iscat) {
        ...
        this.addBehavior(new uni.gaben.iscat.game.lib.implementations.behaviors.SeparationBehavior(
                uni.gaben.iscat.game.lib.utils.UU.pxToM(48.0), IscatBomberSettings.FORCE * 0.8));
