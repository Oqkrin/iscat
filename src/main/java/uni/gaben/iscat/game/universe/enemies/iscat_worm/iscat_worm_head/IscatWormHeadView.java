package uni.gaben.iscat.game.universe.enemies.iscat_worm.iscat_worm_head;
...
import static uni.gaben.iscat.game.universe.enemies.iscat_worm.iscat_worm_head.IscatWormHeadSettings.*;
...
public class IscatWormHeadView extends AbstractEntityView<IscatWormHeadModel>
    ...
    private static final String SPRITE_PATH = "/uni/gaben/iscat/sprites/enemies/iscat_worm_head.png";
    ...
    public IscatWormHeadView() {
        ...
        this.animator = new SpriteSheetsAnimator(0.08, spriteSheet.getTotalFrames(), spriteSheet.getTotalStates());
    }
