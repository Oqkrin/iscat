...
public class ComponentsUtils {
     ...
     */
    public static void applyIconLabel(Label label, String iconCode) {
     ...
     */
    public static void applyIconButton(Button button, String iconCode) {
     ...
     */
    public static void setupButtonHoverTween(Node button) {
        if (button == null) return;
     ...
     */
    public static void playSpawnTween(Node node) {
        if (node == null) return;
