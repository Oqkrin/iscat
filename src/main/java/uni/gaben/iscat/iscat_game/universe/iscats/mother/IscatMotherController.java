...
import static uni.gaben.iscat.iscat_game.universe.iscats.mother.IscatMotherSettings.ISCATMOTHER;
...
public class IscatMotherController extends AiBehaviours<IscatMotherModel> {
    ...
    private void spawnMinions() {
        ...
        for (int i = 0; i < total; i++) {
            ...
            double px = uni.gaben.iscat.iscat_game.utils.UU.mToPx(x);
            double py = uni.gaben.iscat.iscat_game.utils.UU.mToPx(y);
