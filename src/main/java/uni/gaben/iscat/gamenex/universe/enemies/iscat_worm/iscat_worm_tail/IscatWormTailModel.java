...
public class IscatWormTailModel extends LivingEntityModel implements IscatWormSegment {

    private boolean consumed = false;

    public IscatWormTailModel(double x, double y) {
        super(x, y, IscatWormTailSettings.HP_INIZIALI, IscatWormTailSettings.HP_INIZIALI);

        BodyFixture fixture = addFixture(
                Geometry.createCircle(
                        UU.pxToM(IscatWormTailSettings.DIM_SPRITE * IscatWormTailSettings.SCALE / 2.0 * 0.75)));
    ...
    public double getTerminalVelocity() {
        return IscatWormTailSettings.MAX_VELOCITY_MS;
    }
