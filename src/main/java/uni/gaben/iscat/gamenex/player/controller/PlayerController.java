...
public class PlayerController {
    ...
    public void processInput(PlayerModel player, InputManager input, double cameraX, double cameraY) {
        ...
        double targetWorldX = (input.mouseX + cameraX) / PhysicsSettings.SCALE;
        double targetWorldY = (input.mouseY + cameraY) / PhysicsSettings.SCALE;
