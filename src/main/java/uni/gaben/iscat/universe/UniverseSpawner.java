...
import uni.gaben.iscat.universe.iscats.fake.FakeIscatController;
import uni.gaben.iscat.universe.iscats.fake.FakeIscatModel;
import uni.gaben.iscat.universe.iscats.fallen_star_golem.FallenStarGolemController;
import uni.gaben.iscat.universe.iscats.fallen_star_golem.FallenStarGolemModel;
import uni.gaben.iscat.universe.iscats.core.IscatCoreController;
import uni.gaben.iscat.universe.iscats.core.IscatCoreModel;
import uni.gaben.iscat.universe.iscats.dasher.IscatDasherController;
import uni.gaben.iscat.universe.iscats.dasher.IscatDasherModel;
import uni.gaben.iscat.universe.iscats.master.IscatMasterController;
import uni.gaben.iscat.universe.iscats.master.IscatMasterModel;
import uni.gaben.iscat.universe.iscats.mother.IscatMotherController;
import uni.gaben.iscat.universe.iscats.mother.IscatMotherModel;
import uni.gaben.iscat.universe.iscats.worm.IscatWormController;
import uni.gaben.iscat.universe.iscats.worm.IscatWormModel;
...
import uni.gaben.iscat.universe.iscats.eater.IscatEaterController;
import uni.gaben.iscat.universe.iscats.eater.IscatEaterModel;
import uni.gaben.iscat.universe.iscats.mob.IscatMobController;
import uni.gaben.iscat.universe.iscats.mob.IscatMobModel;
import uni.gaben.iscat.universe.iscats.bomber.IscatBomberController;
...
public class UniverseSpawner {
    ...
    public Object spawn(UniverseSpawnable type, double x, double y) {
        return switch (type) {
            ...
            case ISCAT_HEALER -> spawnStandard(uni.gaben.iscat.universe.iscats.healer.IscatHealerModel::new, uni.gaben.iscat.universe.iscats.healer.IscatHealerController::new, x, y);
