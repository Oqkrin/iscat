 ...
 * a un'istanza di {@link GenericPhysicalEntitySettings} interamente popolata da database.
 */
public class GenericEntityModel extends LivingEntityModel implements HasSprite, HasShockwave {
    ...
    private final GenericPhysicalEntitySettings settings;
     ...
     */
    public GenericEntityModel(double x, double y, GenericPhysicalEntitySettings settings) {
     ...
     */
    public GenericPhysicalEntitySettings getSettings() {
        return settings;
    }
