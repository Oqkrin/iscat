...
/**
 * Utility class responsabile del rendering degli elementi di interfaccia grafica (UI/HUD)
...
public final class InterfaceVFX {
    ...
    /**
     * Disegna un indicatore di variazione dell'endurance (testo fluttuante dei danni o delle cure).
     * Il colore del testo viene determinato dinamicamente dal segno del valore:
     * rosso per i danni (valori negativi) e verde per la rigenerazione (valori positivi),
     * attingendo direttamente dai colori definiti nel {@link ThemeManager}.
     * @param enduranceIndicator l'oggetto contenente i dati, la posizione e l'opacità dell'indicatore fluttuante
    ...
    /**
     * Disegna una barra degli HP bidimensionale composta da uno sfondo di danno (rosso)
     * e un riempimento proporzionale alla vita rimasta (verde).
     * <p>
     * Questo metodo accetta parametri primitivi disaccoppiati per consentire il disegno
     * diretto sia da entità standard che da strutture dati di batch protette o locali.
     * </p>
     *
     * @param gc      il {@link GraphicsContext} del canvas su cui effettuare il disegno
     ...
     * @param percent la percentuale di salute attuale, espressa come valore compreso tra {@code 0.0} e {@code 1.0}
     */
