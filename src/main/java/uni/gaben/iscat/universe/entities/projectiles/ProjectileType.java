...
public enum ProjectileType {
    ...
    STUN_BULLET(UniverseVelocitySettings.ENEMY_PROJECTILE_VELOCITY, 7.0, UniverseCollisionLayers.ENEMY_PROJECTILE_FILTER, ThemeManager.getInstance().getAccentTertiary());
